...
var r = fstream.Reader({
  ...
  filter: function () {
    return !that.basename.match(/^\./) &&
      !that.basename.match(/^node_modules$/) &&
      !that.basename.match(/^deep-copy$/) &&
      !that.basename.match(/^filter-copy$/)
  }
})

// that writer will only write directories
var w = fstream.Writer({
  path: path.resolve(__dirname, 'filter-copy'),
  type: 'Directory',
  filter: function () {
    return that.type === 'Directory'
  }
})
